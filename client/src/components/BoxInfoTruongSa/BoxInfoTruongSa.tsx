    ...
    function displayInformation() {
      switch (place) {
        case "diaDiem1":
          ...
          setshowImg1(image.daoTSL);
          setshowImg2(image.daoTSL2);
          break;
        case "diaDiem2":
          ...
          setshowImg1(image.daoSTT);
          setshowImg2(image.daoSTT2);
          break;
        case "diaDiem3":
        ...
        case "diaDiem4":
          ...
          setshowImg1(image.daoAnBang);
          setshowImg2(image.daoAnBang2);
          break;
