...
const ModalQuestionLS = ({ open, onClose, question }: ModalAction) => {
  ...
  const handleCheckDN = (key: number) => {
    console.log(question.imageExplain);
    if (!isSelected) {
      setIsSelected(true);
...
export default ModalQuestionLS;
